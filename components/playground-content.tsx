...
export function PlaygroundContent() {
  ...
  const [madeImage, setMadeImage] = useState<string | null>(null)
  ...
  const [freeGenerationsUsed, setFreeGenerationsUsed] = useState(5) // Example: 5 used out of 20
  ...
  const handleMake = () => {
    if (!selectedStyle) {
      toast({
        ...
        description: "Please select a style before making.",
        variant: "destructive",
      })
      return
    }
    ...
    setTimeout(() => {
      ...
      setFreeGenerationsUsed((prev) => Math.min(prev + 1, 20))
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="make" className="space-y-6 mt-6">
              {!selectedStyle ? (
                <Card>
                  <CardHeader>
                ...
                <>
                  ...
                  <Card>
                        ...
                        {advancedSettings && (
                          <div className="space-y-4 pt-2">
                            ...
                            <div>
                              ...
                              <Textarea
                                id="negative-prompt"
                                placeholder="Describe what you want to avoid in the creation..."
                                value={negativePrompt}
                                onChange={(e) => setNegativePrompt(e.target.value)}
                                className="mt-1.5 min-h-[80px]"
                              />
                              <p className="text-xs text-muted-foreground mt-1">
                                Specify elements you want to exclude from the made image.
                              </p>
                            </div>
                    ...
                    <CardFooter className="flex justify-between">
                      ...
                      <Button onClick={handleMake} disabled={isMaking || !isPromptValid}>
                        {isMaking ? (
                          <>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Upload reference images to guide the creation towards a specific look or subject.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Use negative prompts to specify what you don't want in the made image.
                    </p>
                  </div>
                </div>
                ...
                {popularStyles.map((style) => (
                  ...
                  >
                    ...
                    <Badge variant="secondary" className="text-xs">
                      {style.stats.creations.toLocaleString()}
                    </Badge>
                  </div>
                ))}
              </div>
